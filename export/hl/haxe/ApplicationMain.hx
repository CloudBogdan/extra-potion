...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("extra-potion", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("extra-potion", null, 960, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "20";
		app.meta["company"] = "Bogdanov";
		app.meta["file"] = "extra-potion";
		app.meta["name"] = "Extra Potion";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "1.1.0";
